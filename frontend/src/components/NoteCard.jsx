...
export default function NoteCard({ title, description, updated, id, getNotes }) {
    ...
    return (
        ...
        <Sheet
            ...
            variant="outlined"
        >
            <Box sx={{ position: '' }} onClick={() => { setOpen(true) }}>
                    ...
                    <div onClick={(e) => e.stopPropagation()}>
                        <Dropdown >
                            ...
                            <Menu>
                                ...
                                <MenuItem color="danger" onClick={() => deleteNote(id, getNotes)}>Delete</MenuItem>
                            </Menu>
                        </Dropdown>
                    </div>
                </Box>
